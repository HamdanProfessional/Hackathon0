...
class TwitterApprovalMonitor:
    ...
    def _publish_to_twitter(self, post_details: dict) -> bool:
        """
        Publish content to Twitter using the twitter_poster script.
        ...
        """
        try:
            # Get the twitter_poster.py path
            ...
            poster_script = vault_root / "scripts" / "social-media" / "twitter_poster.py"

            if not poster_script.exists():
                print(f"[ERROR] Twitter poster script not found: {poster_script}")
                return False
            ...
            # Call the twitter_poster script
            ...
            print("[ERROR] Twitter poster timed out")
            return False
        except Exception as e:
            print(f"[ERROR] Error running twitter_poster: {e}")
            return False
