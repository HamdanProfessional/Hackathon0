...
class FacebookApprovalMonitor:
    ...
    def _publish_to_facebook(self, post_details: dict) -> bool:
        """
        Publish content to Facebook using facebook_poster_v2.py
        ...
        try:
            ...
            if not poster_script.exists():
                print(f"[ERROR] Facebook poster script not found: {poster_script}")
                return False
            ...
            # Call the facebook poster script
            ...
            print("[ERROR] Facebook poster timed out")
            return False
        except Exception as e:
            print(f"[ERROR] Error running facebook_poster: {e}")
            return False
