...
class MetaApprovalHandler(FileSystemEventHandler):
    ...
    def _publish_to_meta(self, post_details: dict) -> bool:
        """
        Publish content to Meta Business Suite using the meta_poster script.
        ...
        try:
            ...
            # Use direct Instagram poster for Instagram-only posts
            platforms = post_details.get('platforms', [])
            ...
            if is_instagram_only:
                ...
                poster_script = vault_root / "scripts" / "social-media" / "meta_poster_v2.py"
